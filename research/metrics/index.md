...
---
# _PCMDI Simulation Summaries ([v1.0.0][v1.0.1])_

The [PCMDI Metrics Package (PMP)](https://github.com/PCMDI/pcmdi_metrics) is a capability that can be used to produce a diverse suite of objective summaries of Earth System Model (ESM) agreement with observations. At PCMDI, we are routinely applying the PMP to multiple generations of CMIP, including the most recent results from CMIP6 as they become available. The summaries below will be regularly updated with new and an expanding set of results.  For most cases, interactive plots can be navigated to reveal the underlying diagnostics from which each statistic was derived. 
...
---
## Updates
- [**v1.0.1**][v1.0.1] (12 July 2019): Minor text changes on homepage
...
[v1.0.1]: {{site.baseurl}}/research/metrics/index.html
